...
export const metadata: Metadata = {
  title: 'Home',
  description: 'Welcome to Tayyab Manan\'s portfolio - Professional GIS analyst and spatial developer with expertise in urban planning, environmental analysis, and geospatial technology solutions.',
  openGraph: {
