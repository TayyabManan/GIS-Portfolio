              ...
              >
                ...
                <div className="mt-8 flex flex-row items-center gap-4 flex-wrap">
                  <a
                    ...
                    className="bg-[var(--primary)] px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base font-semibold text-white shadow-lg hover:bg-[var(--primary-hover)] hover:shadow-xl rounded-lg transition-all duration-200 transform hover:scale-105 cursor-pointer inline-flex items-center gap-2"
                  >
                    View Projects
