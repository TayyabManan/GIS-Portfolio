      ...
      <Dialog as="div" className="relative z-50" onClose={onClose}>
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-xl bg-white dark:bg-gray-800 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-3xl">
                {/* Close button */}
                <button
                  type="button"
                ...
                {/* Image section */}
                <div className="relative h-64 sm:h-80 bg-gradient-to-br from-blue-500 to-emerald-500 overflow-hidden">
                  {project.image ? (
                    <Image
                      src={project.image}
                      alt={project.title}
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-4">
                      {project.demoUrl && (
                        <a
                          ...
                          className="flex-1 inline-flex items-center justify-center gap-2 rounded-md bg-blue-600 px-4 py-3 text-sm font-semibold text-white shadow-sm hover:bg-blue-700 transition-colors"
                        >
                      ...
                      {project.githubUrl && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="flex-1 inline-flex items-center justify-center gap-2 rounded-md bg-gray-900 dark:bg-gray-700 px-4 py-3 text-sm font-semibold text-white shadow-sm hover:bg-gray-800 dark:hover:bg-gray-600 transition-colors"
                        >
