...
export default function ShareButtons({ title, url }: ShareButtonsProps) {
  ...
  const handleCopyLink = async () => {
    try {
      ...
      toast.error('Couldn\'t copy link', 'Try copying the URL from the address bar.')
    }
  }
  ...
  return (
    <div className="relative">
      <button
        ...
        className="inline-flex items-center gap-2 px-4 py-2 min-h-[44px] bg-[var(--primary)] text-[var(--on-primary)] rounded-lg hover:bg-[var(--primary-hover)] transition-colors font-medium cursor-pointer"
        ...
        <>
          ...
          >
            ...
            <div className="space-y-2">
              ...
              >
                <svg className="h-5 w-5 text-[var(--text)]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <button
                ...
                className="w-full flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-[var(--background-secondary)] transition-colors text-left cursor-pointer"
              >
                <svg className="h-5 w-5 text-[var(--primary)]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <button
                ...
                className="w-full flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-[var(--background-secondary)] transition-colors text-left cursor-pointer"
              >
                <svg className="h-5 w-5 text-[#FF4500]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
