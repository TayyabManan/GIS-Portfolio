...
export default function BackToTop() {
  ...
  return (
    <button
      onClick={scrollToTop}
      className={`fixed bottom-8 right-8 z-50 p-3 bg-[var(--primary)] text-[var(--on-primary)] rounded-full hover:bg-[var(--primary-hover)] transition-[opacity,translate,background-color,transform] duration-200 ease-out active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-[var(--primary)] focus:ring-offset-2 ${
